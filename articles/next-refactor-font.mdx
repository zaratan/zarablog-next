...
Ça va impliquer qu'après le chargement de votre police finale la texte voir le layout de la page risque de bouger et perturber la lecture et/ou le rendu.
...
Ne négligez pas vos fonts c'est une façon facile de gagner en performance et en usabilité avec quelques techniques _in-fine_ assez simples.
