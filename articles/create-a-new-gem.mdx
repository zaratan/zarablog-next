...
Il est souvent bon d’écrire une documentation des différentes méthode à même notre code et ce pour plusieurs raisons:
* Ça permet aux autres personnes qui voudraient utiliser notre gem de savoir ce a quoi servent les différentes classes et méthodes
* Ça permet à solargraph de faire de l’autocompletion
...
Et ensuite on va documenter chaque méthode de la manière suivante:
...
Et ensuite, suivant la [documentation](https://github.com/fxn/zeitwerk#for_gem), dans notre fichier principal presque tout en haut on fait:

<FileName external baseUrl="https://github.com/zaratan/activeshotgun/blob/main/" filename="lib/activeshotgun.rb" />
...
Et c’est tout. Les différents fichiers seront require correctement.
