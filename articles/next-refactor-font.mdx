...
Eventuellement ça va impliquer devoir la servir depuis un CDN configuré par vos soins ou avec le reste de votre site web.
...
[Overlap tool](https://meowni.ca/font-style-matcher/)
